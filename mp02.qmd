...
DT::datatable(
  most_ds_per_year |>
    arrange(desc(YEAR)) |>
    slice_head(n = 5) |>
    select(YEAR, cbsa_code, cbsa_name),  
...
```
From the visual above, we get the list below of CBSAs that meet all 4 criteria. In total, it is 27 CBSAs that are most YIMBY.
```{r}
#| echo: false
#| message: false
#| warning: false
...
[The “Rebuild the American Dream Act”](act.qmd)
